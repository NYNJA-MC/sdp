...
final public class Rule_CFWS extends Rule
{
  public Rule_CFWS(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_CFWS parse(ParserContext context)
  {
    context.push("CFWS");
    ...
    if (parsed)
    {
        rule = new Rule_CFWS(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

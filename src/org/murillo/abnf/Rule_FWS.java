...
final public class Rule_FWS extends Rule
{
  public Rule_FWS(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_FWS parse(ParserContext context)
  {
    context.push("FWS");
    ...
    if (parsed)
    {
        rule = new Rule_FWS(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_IP6_multicast extends Rule
{
  public Rule_IP6_multicast(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_IP6_multicast parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_IP6_multicast(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

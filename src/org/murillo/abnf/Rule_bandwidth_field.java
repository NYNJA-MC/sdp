...
final public class Rule_bandwidth_field extends Rule
{
  public Rule_bandwidth_field(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_bandwidth_field parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_bandwidth_field(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

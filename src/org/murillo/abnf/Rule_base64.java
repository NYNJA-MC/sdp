...
final public class Rule_base64 extends Rule
{
  public Rule_base64(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_base64 parse(ParserContext context)
  {
    context.push("base64");
    ...
    if (parsed)
    {
        rule = new Rule_base64(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

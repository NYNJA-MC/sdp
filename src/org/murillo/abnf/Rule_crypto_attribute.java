...
final public class Rule_crypto_attribute extends Rule
{
  public Rule_crypto_attribute(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_crypto_attribute parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_crypto_attribute(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

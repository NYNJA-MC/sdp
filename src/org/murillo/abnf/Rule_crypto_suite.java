...
final public class Rule_crypto_suite extends Rule
{
  public Rule_crypto_suite(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_crypto_suite parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_crypto_suite(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_decimal_uchar extends Rule
{
  public Rule_decimal_uchar(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_decimal_uchar parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_decimal_uchar(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

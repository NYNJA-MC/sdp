...
final public class Rule_decimal_uchar_25x extends Rule
{
  public Rule_decimal_uchar_25x(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_decimal_uchar_25x parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_decimal_uchar_25x(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_decimal_uchar_2xx extends Rule
{
  public Rule_decimal_uchar_2xx(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_decimal_uchar_2xx parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_decimal_uchar_2xx(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

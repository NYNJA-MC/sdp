...
final public class Rule_domain_literal extends Rule
{
  public Rule_domain_literal(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_domain_literal parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_domain_literal(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

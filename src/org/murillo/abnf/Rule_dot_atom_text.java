...
final public class Rule_dot_atom_text extends Rule
{
  public Rule_dot_atom_text(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_dot_atom_text parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_dot_atom_text(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_email_field extends Rule
{
  public Rule_email_field(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_email_field parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_email_field(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_extmap_attribute extends Rule
{
  public Rule_extmap_attribute(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_extmap_attribute parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_extmap_attribute(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

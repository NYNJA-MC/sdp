...
final public class Rule_fingerprint extends Rule
{
  public Rule_fingerprint(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_fingerprint parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_fingerprint(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

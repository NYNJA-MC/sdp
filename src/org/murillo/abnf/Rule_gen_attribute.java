...
final public class Rule_gen_attribute extends Rule
{
  public Rule_gen_attribute(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_gen_attribute parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_gen_attribute(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

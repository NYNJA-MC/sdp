...
final public class Rule_key_params extends Rule
{
  public Rule_key_params(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_key_params parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_key_params(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

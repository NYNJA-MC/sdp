...
final public class Rule_m1 extends Rule
{
  public Rule_m1(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_m1 parse(ParserContext context)
  {
    context.push("m1");
    ...
    if (parsed)
    {
        rule = new Rule_m1(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_media_description extends Rule
{
  public Rule_media_description(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_media_description parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_media_description(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

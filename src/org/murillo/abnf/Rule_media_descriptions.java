...
final public class Rule_media_descriptions extends Rule
{
  public Rule_media_descriptions(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_media_descriptions parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_media_descriptions(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_obs_FWS extends Rule
{
  public Rule_obs_FWS(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_obs_FWS parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_obs_FWS(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

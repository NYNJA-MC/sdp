...
final public class Rule_origin_field extends Rule
{
  public Rule_origin_field(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_origin_field parse(ParserContext context)
  {
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Terminal_NumericValue.parse(context, "%x6f", "[\\x6f]", 1);
          if ((f1 = rule != null))
          {
    ...
    if (parsed)
    {
        rule = new Rule_origin_field(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

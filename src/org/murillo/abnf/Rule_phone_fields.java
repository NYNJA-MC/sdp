...
final public class Rule_phone_fields extends Rule
{
  public Rule_phone_fields(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_phone_fields parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_phone_fields(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

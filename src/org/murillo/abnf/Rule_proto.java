...
final public class Rule_proto extends Rule
{
  public Rule_proto(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_proto parse(ParserContext context)
  {
    context.push("proto");
    ...
    if (parsed)
    {
        rule = new Rule_proto(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_repeat_interval extends Rule
{
  public Rule_repeat_interval(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_repeat_interval parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_repeat_interval(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

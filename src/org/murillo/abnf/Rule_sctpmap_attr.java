...
final public class Rule_sctpmap_attr extends Rule
{
  public Rule_sctpmap_attr(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_sctpmap_attr parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_sctpmap_attr(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_session_description extends Rule
{
  public Rule_session_description(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_session_description parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_session_description(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

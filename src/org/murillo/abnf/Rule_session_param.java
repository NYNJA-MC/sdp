...
final public class Rule_session_param extends Rule
{
  public Rule_session_param(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_session_param parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_session_param(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

...
final public class Rule_ssrc_attr extends Rule
{
  public Rule_ssrc_attr(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ssrc_attr parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_ssrc_attr(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

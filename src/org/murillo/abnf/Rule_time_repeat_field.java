...
final public class Rule_time_repeat_field extends Rule
{
  public Rule_time_repeat_field(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_time_repeat_field parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_time_repeat_field(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

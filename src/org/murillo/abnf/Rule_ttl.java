...
final public class Rule_ttl extends Rule
{
  public Rule_ttl(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ttl parse(ParserContext context)
  {
    context.push("ttl");
    ...
    if (parsed)
    {
        rule = new Rule_ttl(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

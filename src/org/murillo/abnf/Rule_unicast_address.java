...
final public class Rule_unicast_address extends Rule
{
  public Rule_unicast_address(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_unicast_address parse(ParserContext context)
  {
    ...
    if (parsed)
    {
        rule = new Rule_unicast_address(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;

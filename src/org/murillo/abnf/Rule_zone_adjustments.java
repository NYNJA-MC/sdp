...
final public class Rule_zone_adjustments extends Rule
{
  public Rule_zone_adjustments(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_zone_adjustments parse(ParserContext context)
  {
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Terminal_NumericValue.parse(context, "%x7a", "[\\x7a]", 1);
          if ((f1 = rule != null))
          {
    ...
    if (parsed)
    {
        rule = new Rule_zone_adjustments(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
